...
struct ImageBottomSheetViewControllerRepresentable: UIViewControllerRepresentable {
    @Binding var isPresented: Bool
    
    class Coordinator: NSObject, UIViewControllerTransitioningDelegate {
        var parent: ImageBottomSheetViewControllerRepresentable
        
        init(parent: ImageBottomSheetViewControllerRepresentable) {
            self.parent = parent
        }
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        ...
        if isPresented {
            let bottomSheetVC = ImageBottomSheetViewController()
